...
namespace VLB
{
    ...
    public class VolumetricLightBeam : MonoBehaviour
    {
        ...
        /// </summary>
        [Range(0f, 1f)]
        public float alphaInside = Consts.Alpha;
        ...
        [Range(0f, 1f)]
        public float alphaOutside = Consts.Alpha;
        ...
        /// </summary>
        [Range(Consts.NoiseIntensityMin, Consts.NoiseIntensityMax)]
        public float noiseIntensity = Consts.NoiseIntensityDefault;
        ...
        public float noiseScaleLocal = Consts.NoiseScaleDefault;
...
#pragma warning restore 0414
        ...
        [SerializeField]
        bool _TrackChangesDuringPlaytime = false;

        [SerializeField]
        int _SortingLayerID = 0;
        [SerializeField]
        int _SortingOrder = 0;
